            ...
            for j in range(6):
                if j not in helpless:
                    ...
                    for k in range(3):
                        ...
                        #in almost solve and reduce at most 3 steps. Return if more
                        for index in range(len(almostrightedge)):
                            if newedge==almostrightedge[index] and newedged==almostrightedged[index]:
                                furthersolution=almostrightsolution[index]
